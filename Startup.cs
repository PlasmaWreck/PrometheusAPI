...
namespace PrometheusAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<OperatingSystemService>();
            services.AddScoped<CaseService>();
            services.AddScoped<OpticalDriveService>();
            ...
            services.AddCors( options => {
                ...
                builder => builder.WithOrigins("http://localhost:4200", "https://pcpapi.azurewebsites.net")
                                    .AllowAnyHeader()
                                    .AllowAnyMethod()
                                    .AllowCredentials());
            });

            var connectionString = Configuration.GetConnectionString("MyString");
